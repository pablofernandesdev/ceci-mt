...
using CeciMT.Domain.Mapping;
using CeciMT.Infra.CrossCutting.Settings;
using CeciMT.Infra.Data.Context;
using CeciMT.Service.Validators.User;
using CeciMT.WebApplication.Attribute;
using CeciMT.WebApplication.Dependencys;
using CeciMT.WebApplication.Extensions;
using CeciMT.WebApplication.Filters;
...
namespace CeciMT.WebApplication
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                var xmls = new List<string>(new string[] { Path.Combine(AppContext.BaseDirectory, "CeciMT.WebApplication.xml"),
                    Path.Combine(AppContext.BaseDirectory, "CeciMT.Domain.xml") });
