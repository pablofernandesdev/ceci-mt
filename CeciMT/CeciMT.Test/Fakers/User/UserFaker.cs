...
namespace CeciMT.Test.Fakers.User
{
    public static class UserFaker
    {
        public static Faker<CeciMT.Domain.Entities.User> UserEntity()
        {
            return new Faker<CeciMT.Domain.Entities.User>()
                .CustomInstantiator(p => new CeciMT.Domain.Entities.User
                {
                    ...
                    RefreshToken = new List<CeciMT.Domain.Entities.RefreshToken>(),
                    RegistrationDate = p.Date.Recent(),
                    RegistrationToken = new List<CeciMT.Domain.Entities.RegistrationToken>(),
                    Validated = p.Random.Bool(),
                    ValidationCode = new List<CeciMT.Domain.Entities.ValidationCode>(),
