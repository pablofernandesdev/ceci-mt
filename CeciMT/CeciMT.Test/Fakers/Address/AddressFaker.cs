...
namespace CeciMT.Test.Fakers.Address
{
    public static class AddressFaker
    {
        public static Faker<CeciMT.Domain.Entities.Address> AddressEntity()
        {
            return new Faker<CeciMT.Domain.Entities.Address>()
                .CustomInstantiator(p => new CeciMT.Domain.Entities.Address
                {
                    Id = p.Random.Int(),
